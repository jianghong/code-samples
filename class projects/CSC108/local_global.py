...
def scale_blue(pic, new_blue):
    ...
    new_blue >= 0.0 and new_blue <= 255.0
...
def scale_green(pic, new_green):
    ...
    new_green >= 0.0 and new_green <= 255.0
...
def expand_height(pic, expand_factor):
    ...
    expand_factor > 0
    height = expand_factor * media.height
    width = media.width
...
def expand_width(pic, expand_factor):
    ...
    height = media.height
    width = expand_factor * media.width
    new_pic = media.create_picture(width, height, media.black) 
