...
if __name__ == '__main__':
    ...
    #game = Ghost([(True, 42), (True, 42)], "medium.txt")

    # play against a dumbed down computer, based on a large word list
    #game = Ghost([(True, 42), (False, 0.5)], "long.txt")

    # play against two dumbed down computers, based on a large word list
    game = Ghost([(False, 1), (True, 42), (False, 0.5)], "long.txt")
